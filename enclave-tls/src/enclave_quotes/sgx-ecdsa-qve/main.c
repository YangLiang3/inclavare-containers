...
extern enclave_quote_err_t sgx_ecdsa_qve_collect_evidence(enclave_quote_ctx_t *ctx,
						      attestation_evidence_t *evidence,
						      enclave_tls_cert_algo_t algo,
						      uint8_t *hash);
extern enclave_quote_err_t sgx_ecdsa_qve_verify_evidence(enclave_quote_ctx_t *ctx,
						     attestation_evidence_t *evidence,
						     uint8_t *hash);
...
static enclave_quote_opts_t sgx_ecdsa_qve_opts = {
	...
	.collect_evidence = sgx_ecdsa_qve_collect_evidence,
	.verify_evidence = sgx_ecdsa_qve_verify_evidence,
